...
def test_get_default_hour_time_filter_matches_current_segment():
    """The default pill selection must match the current time's segment."""
    assert get_default_hour_time_filter("2024-01-01T09:00") == "morning"
    assert get_default_hour_time_filter("2024-01-01T15:00") == "afternoon"
    assert get_default_hour_time_filter("2024-01-01T19:00") == "evening"
    assert get_default_hour_time_filter("2024-01-01T02:00") == "night"


def test_get_default_hour_time_filter_falls_back_to_all():
